...
namespace ConferenceMVC.Web.Controllers
{
    public class SpeakersController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Name,Surname,Email,Password,ConferenceId,CompanyId,Description,Id")] Speaker speaker)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Name,Surname,Email,Password,ConferenceId,CompanyId,Description,Id")] Speaker speaker)
        {
            if (id != speaker.Id)
            {
                return NotFound();
